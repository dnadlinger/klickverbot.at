...
<head>
  ...
  <title>d4 | David Nadlinger</title>
...
(columns2)* "(icon tar)d4 0.1 binaries, Linux 32 bit":http://github.com/downloads/klickverbot/d4/d4-0.1-linux-x86_32.tar.gz
 * "(icon zip)d4 0.1 binaries, Windows 32 bit":http://github.com/downloads/klickverbot/d4/d4-0.1-windows-x86_32.zip
...
The full source tree of this project, representing the latest state of development, is available at "GitHub":http://github.com/dnadlinger/d4/. You are absolutely encouraged to fork the project and start hacking right away.

If you want to tell me about any bugs or have sugestions for improvement, please <a href="http://github.com/dnadlinger/d4/issues">file an issue</a> or contact me via email (see "About":/about#contact).
