...
Recently, I have been playing around with a units of measurement implementation for D2/Phobos. I've yet to write a detailed description – for now, please see the code ("std/units.d":https://github.com/klickverbot/phobos/blob/units/std/units.d and "std/si.d":https://github.com/klickverbot/phobos/blob/units/std/si.d in my Phobos fork on GitHub), the DDoc documentation ("std.units":std_units.html and "std.si":std_si.html).
