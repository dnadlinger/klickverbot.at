...
The full source tree of this project, representing the latest state of development, is available at "GitHub":http://github.com/klickverbot/{{ page.github_name }}/. You are absolutely encouraged to fork the project and start hacking right away.

If you want to tell me about any bugs or have sugestions for improvement, please <a href="http://github.com/klickverbot/{{ page.github_name }}/issues">file an issue</a> or contact me via email (see "About":/about#contact).
